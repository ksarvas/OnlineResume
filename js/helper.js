var HTMLheaderPic = '<div id="header-pic"><img src="%data%"></div>';
...
var HTMLcontactStart = '<h3>Contact Me</h3><ul id="topContacts" class="flex-box"></ul>';
...
var HTMLskillsStart = '<h3>My Skills</h3><ul id="skillList" class="flex-column"></ul>';
